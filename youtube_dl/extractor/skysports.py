...
class Laola1TvIE(InfoExtractor):
    _VALID_URL = r'http?://(?:www\.)?skysports\.com/(?P<lang>[a-z]+)-(?P<portal>[a-z]+)/(?P<kind>[^/]+)/(?P<slug>[^/?#&]+)'
    _TESTS = [{
        'url': 'http://www.skysports.com/watch/video/10286744/united-fans-frustrated',
        'info_dict': {
            'id': '10286744',
            'display_id': 'united-fans-frustrated',
            'ext': 'flv',
            'title': 'United fans 'frustrated'',
